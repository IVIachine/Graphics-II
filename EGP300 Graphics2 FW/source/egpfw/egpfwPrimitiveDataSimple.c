...
void egpfwDrawTexturedUnitQuadImmediate(const float *mvp, const int mvpLoc)
{
	...
	glLoadMatrixf(mvp);
	glBegin(GL_TRIANGLE_STRIP);
	glBindTexture(GL_TEXTURE_2D, egpfwGetUnitQuadTexcoords());
	//glColor3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0, 0);
	glVertex3f(-1.0f, 1.0f, 0.0f);
	...
	/*
	//glColor3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(egpfwGetUnitQuadTexcoords()[0], egpfwGetUnitQuadTexcoords()[1]);
	glVertex3f(-1.0f, 1.0f, 0.0f);

	//glColor3f(0.0f, 0.0f, 0.0f);
	glTexCoord2f(egpfwGetUnitQuadTexcoords()[2], egpfwGetUnitQuadTexcoords()[3]);
	glVertex3f(-1.0f, -1.0f, 0.0f);

	//glColor3f(1.0f, 1.0f, 0.0f);
	glTexCoord2f(egpfwGetUnitQuadTexcoords()[4], egpfwGetUnitQuadTexcoords()[5]);
	glVertex3f(1.0f, 1.0f, 0.0f);

	//glColor3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(egpfwGetUnitQuadTexcoords()[6], egpfwGetUnitQuadTexcoords()[7]);
	glVertex3f(1.0f, -1.0f, 0.0f);
	*/
}
